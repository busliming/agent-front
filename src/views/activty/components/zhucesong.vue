    ...
    >
      <el-row type="flex" justify="start">
        <el-form-item prop="amount" label="金额" style="width:300px;margin-right:15px;">
          <el-input v-model="formData.amount" placeholder="对应注册送界面数值会发生相应变化" clearable></el-input>
        </el-form-item>
        <el-form-item label-width="0" style="width:160px;margin-right: 0;">
